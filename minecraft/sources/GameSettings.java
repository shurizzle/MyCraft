...
public class GameSettings
{
    ...
    public GameSettings(Minecraft minecraft, File file)
    {
        ...
        joinserver_url = "http://session.minecraft.net/game/joinserver.jsp";
        skins_url = "http://s3.amazonaws.com/MinecraftSkins/";
        resources_url = "http://s3.amazonaws.com/MinecraftResources/";
        download_url = "http://s3.amazonaws.com/MinecraftDownload/";
        has_paid_url = "https://login.minecraft.net/session";
        cloacks_url = "http://s3.amazonaws.com/MinecraftCloaks/";
        mc = minecraft;
        ...
        try
        {
            ...
            for(String s = ""; (s = bufferedreader.readLine()) != null;)
            {
                try
                {
                    ...
                    if(as[0].equals("url.login"))
                    {
                      login_url = as[1];
                    }
                    if(as[0].equals("url.joinserver"))
                    {
                      joinserver_url = as[1];
                    }
                    if(as[0].equals("url.skins"))
                    {
                      skins_url = as[1];
                    }
                    if(as[0].equals("url.resources"))
                    {
                      resources_url = as[1];
                    }
                    if(as[0].equals("url.download"))
                    {
                      download_url = as[1];
                    }
                    if(as[0].equals("url.has_paid"))
                    {
                      has_paid_url = as[1];
                    }
                    if(as[0].equals("url.cloacks"))
                    {
                      cloacks_url = as[1];
                    }
                    int i = 0;
    ...
    public void saveOptions()
    {
        try
        {
            ...
            printwriter.println((new StringBuilder()).append("url.login:").append(login_url).toString());
            printwriter.println((new StringBuilder()).append("url.joinserver:").append(joinserver_url).toString());
            printwriter.println((new StringBuilder()).append("url.skins:").append(skins_url).toString());
            printwriter.println((new StringBuilder()).append("url.resources:").append(resources_url).toString());
            printwriter.println((new StringBuilder()).append("url.download:").append(download_url).toString());
            printwriter.println((new StringBuilder()).append("url.has_paid:").append(has_paid_url).toString());
            printwriter.println((new StringBuilder()).append("url.cloacks:").append(cloacks_url).toString());
    ...
    public String joinserver_url;
    public String skins_url;
    public String resources_url;
    public String download_url;
    public String has_paid_url;
    public String cloacks_url;
