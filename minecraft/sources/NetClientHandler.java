...
public class NetClientHandler extends NetHandler
{
    ...
    public void handleHandshake(Packet2Handshake packet2handshake)
    {
        ...
        } else
        {
            try
            {
                URL url = new URL((new StringBuilder()).append(mc.gameSettings.joinserver_url).append("?user=").append(mc.session.username).append("&sessionId=").append(mc.session.sessionId).append("&serverId=").append(packet2handshake.username).toString());
